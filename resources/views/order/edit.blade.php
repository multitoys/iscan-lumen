...
{{--        {{ method_field('PUT') }}--}}
        ...
        <div class="row">
            ...
            <div class="col-xs-3">{{ \Carbon\Carbon::parse($order->created_at)->format('d.m.Y H:i') }}</div>
        ...
        <div class="row">
            ...
            <div class="col-xs-3">
                <input id="timepicker-actions-exmpl" name="date_end" type="text" class="form-control"
                       value="{{ isset($order->date_end) ? \Carbon\Carbon::parse($order->date_end)->format('d.m.Y H:i') : '' }}">
            </div>
        </div>
        <hr>
...
<script src="/js/script.js?v_1.11" defer></script>
</body>
</html>